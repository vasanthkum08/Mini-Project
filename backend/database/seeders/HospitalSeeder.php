...
class HospitalSeeder extends Seeder
{
    ...
    {
        // ── 5 DISTINCT MADURAI HOSPITALS FOR PHASE 2 TESTING ─────────────────────
        $maduraiHospitals = [
            [
                'name' => 'Apollo Hospital – Madurai',
                'address' => 'Lake View Road, K.K. Nagar, Madurai, Tamil Nadu',
                'city' => 'Madurai',
                'state' => 'Tamil Nadu',
                'district' => 'Madurai',
                'latitude' => 9.9355,
                'longitude' => 78.0945,
                'phone' => '+91-452-2580888',
                'email' => 'apollo.madurai@emergency.in',
                'specialties' => ['Cardiology', 'Emergency Medicine', 'Neurology', 'Trauma Care', 'Intensive Care'],
            ...
            [
                ...
                'latitude' => 9.9195,
                'longitude' => 78.1191,
                'phone' => '+91-452-2588000',
                'email' => 'meenakshi.madurai@emergency.in',
                'specialties' => ['Cardiology', 'Emergency Medicine', 'Oncology', 'Pediatrics', 'Trauma Care'],
            ...
            [
                ...
                'address' => 'Velammal Village, Madurai-Tuticorin Ring Road, Anuppanadi, Madurai, Tamil Nadu',
                'city' => 'Madurai',
                'state' => 'Tamil Nadu',
                'district' => 'Madurai',
                'latitude' => 9.8812,
                'longitude' => 78.0795,
                'phone' => '+91-452-2510000',
                'email' => 'velammal.madurai@emergency.in',
                'specialties' => ['General Medicine', 'Emergency Medicine', 'Orthopedics', 'Pulmonology', 'Surgery'],
                'available_doctors' => 22,
                'available_icu_beds' => 20,
                'available_general_beds' => 60,
                'emergency_beds' => 15,
                'er_wait_minutes' => 25,
                'queue_count' => 7,
                'hospital_status' => 'Open',
            ...
            [
                'name' => 'Vadamalayan Hospital – Madurai',
                'address' => 'No. 15, Jawahar Road, Chokkikulam, Madurai, Tamil Nadu',
                'city' => 'Madurai',
                'state' => 'Tamil Nadu',
                'district' => 'Madurai',
                'latitude' => 9.9412,
                'longitude' => 78.1035,
                'phone' => '+91-452-2533224',
                'email' => 'vadamalayan.madurai@emergency.in',
                'specialties' => ['Cardiology', 'Neurology', 'Gastroenterology', 'Emergency Medicine', 'Urology'],
                'available_doctors' => 7,
            ...
            [
                'name' => 'Devadoss Multispeciality Hospital – Madurai',
                'address' => 'Survey No. 74/2, Alagar Kovil Main Road, Surveyor Colony, Madurai, Tamil Nadu',
                'city' => 'Madurai',
                'state' => 'Tamil Nadu',
                'district' => 'Madurai',
                'latitude' => 9.9535,
                'longitude' => 78.0855,
                'phone' => '+91-452-4521000',
                'email' => 'devadoss.madurai@emergency.in',
                'specialties' => ['Orthopedics', 'Trauma Care', 'Emergency Medicine', 'Neurosurgery', 'Critical Care'],
                'available_doctors' => 9,
        ...
        $cities = [
            ...
            ['city'=>'Madurai','state'=>'Tamil Nadu','district'=>'Madurai','lat'=>9.9252,'lng'=>78.1198,
                ...
                'coords'=>[[9.9198,78.1194],[9.9215,78.1145],[9.9358,78.0948],[9.8815,78.0798],[9.9415,78.1038],[9.9285,78.1285],[9.9165,78.1135],[9.9538,78.0858]]
            ],
